...
internal class KloggingConfigurationTest :
    DescribeSpec({
            ...
            describe("configuration DSL") {
                ...
                it("allows for complex logging configuration") {
                    ...
                    with(KloggingEngine) {
                        ...
                        sinkConfigs().values.map { it.stringSender } shouldContainAll
                            setOf(
                                STDOUT,
                                STDERR,
                            )
                        sinkConfigs().values.map { it.renderer }.toSet() shouldContainExactly
                            setOf(
                                RENDER_SIMPLE,
                                RENDER_CLEF,
                            )
