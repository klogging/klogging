        ...
        describe("Render a `LogEvent` to a simple string") {
            ...
            describe("evaluates variables in a message") {
                ...
                it("substitutes all substrings matching item entry's \"{KEY}\" for VALUE") {
                    ...
                    RENDER_SIMPLE(event) shouldBe
                        "${ts.localString} INFO [test-thread] Test : User Samuel logged in and has a role admin : {user=Samuel, user_role=admin}"
                }
                ...
                it("doesn't substitute with null") {
                    ...
                    RENDER_SIMPLE(event) shouldBe
                        "${ts.localString} INFO [test-thread] Test : User Samuel logged in and has a role {user_role} : {user=Samuel, user_role=null}"
                }
            }
