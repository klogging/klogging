 ...
 */
public interface KtLogger : BaseLogger {
    ...
    public suspend fun log(level: Level, exception: Exception, event: suspend KtLogger.() -> Any?) {
        if (isLevelEnabled(level)) logMessage(level, exception, event())
    }

    public suspend fun log(level: Level, event: suspend KtLogger.() -> Any?) {
        if (isLevelEnabled(level)) logMessage(level, null, event())
    }

    public suspend fun trace(event: suspend KtLogger.() -> Any?): Unit = log(Level.TRACE, event)
    public suspend fun debug(event: suspend KtLogger.() -> Any?): Unit = log(Level.DEBUG, event)
    public suspend fun info(event: suspend KtLogger.() -> Any?): Unit = log(Level.INFO, event)
    public suspend fun warn(event: suspend KtLogger.() -> Any?): Unit = log(Level.WARN, event)
    public suspend fun error(event: suspend KtLogger.() -> Any?): Unit = log(Level.ERROR, event)
    public suspend fun fatal(event: suspend KtLogger.() -> Any?): Unit = log(Level.FATAL, event)

    public suspend fun trace(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.TRACE, exception, event)
    public suspend fun debug(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.DEBUG, exception, event)
    public suspend fun info(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.INFO, exception, event)
    public suspend fun warn(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.WARN, exception, event)
    public suspend fun error(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.ERROR, exception, event)
    public suspend fun fatal(exception: Exception, event: suspend KtLogger.() -> Any?): Unit = log(Level.FATAL, exception, event)
